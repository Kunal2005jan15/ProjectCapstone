 ...
 * See PaymentService for the mock-vs-real-Razorpay explanation.
 */
@RestController
@RequestMapping("/api/v1/payments")
@RequiredArgsConstructor
@SecurityRequirements
@Tag(name = "Payments", description = "Guest checkout payment flow (mock gateway unless Razorpay keys are configured)")
